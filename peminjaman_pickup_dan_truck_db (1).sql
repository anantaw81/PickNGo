...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2021 at 03:32 PM
...
(3, 'Diva Dwijayana', 'Pria', 120000, '60a2707120f39.png'),
...
(5, 2, 9, '2021-05-03', '2021-05-03', 'Ya', 8, 4, 2, 'not valid payment', '60a3e2c47508d.jpeg'),
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `akun`  AS SELECT 'pelanggan' AS `jenis_akun`, `akun_pelanggan`.`ID_akun` AS `ID_akun`, `akun_pelanggan`.`status_akun` AS `status_akun`, `akun_pelanggan`.`username` AS `username`, `akun_pelanggan`.`password_pelanggan` AS `password_akun` FROM `akun_pelanggan` ;
