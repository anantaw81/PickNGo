...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2021 at 10:13 AM
...
(9, 'semangatgan', '$2y$10$2nSsVlMml8YuJ9S3Qi2cXOTU75ORvJCjMJ7V/L5VTxnfqizxn46Xy', 'not verified', 13);
...
(2, 'Pasha Renaisan', 'Pria', 100000, '60a6160056188.png'),
(4, 'Ananta Wijaya 2', 'Pria', 100000, '60a505906e4af.png'),
(5, 'Diva Dwijayana', 'Pria', 100000, '60a60ab422ca3.png'),
(6, 'Ananta Wijaya', 'Pria', 100000, '60a6143941b31.png');
...
(11, 6, 9, '2021-05-20', '2021-05-21', 1, 8, 20, 1, 'accepted', '60a8b10254053.png', NULL),
...
--
ALTER TABLE `helper`
  MODIFY `ID_helper` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
