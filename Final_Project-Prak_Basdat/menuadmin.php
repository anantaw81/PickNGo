...
<html lang="en">
  ...
  <body>
  	...
  	<div class="sidebar">
  		<h2> Admin </h2>
  		<a href="#" style="background-color: #b34509;"><i class="fa fa-truck"></i><span>List Kendaraan</span></a>
  		<a href="listdriver.php"><i class = "fa fa-address-book"></i><span>List Driver</span></a>
  		<a href="listhelper.php"><i class = "fa fa-address-book-o"></i><span>List Helper</span></a>
  		<a href=""><i class = "fa fa-hourglass"></i><span>Request Peminjaman</span></a>
  		<a href="validasi_user.php"><i class = "fa fa-check-circle"></i><span>Validasi Pengguna</span></a>
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-12">
            <div class="card mt-5 mx-auto" style="width: 18rem;">
              ...
              <div class="card-body text-center">
                <a class="btn btn-primary" href="unitkendaraan.php?p_k_model=<?= $tuple["ID_model"]; ?>" role="button">Lihat Unit</a>
