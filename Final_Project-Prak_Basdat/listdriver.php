...
<html lang="en">
  ...
  <body>
  	...
  	<div class="sidebar">
  		<h2> Admin </h2>	
  		<a href="menuadmin.php"><i class="fa fa-truck"></i><span>List Kendaraan</span></a>
  		<a href="listdriver.php" style="background-color: #b34509;"><i class = "fa fa-address-book"></i><span>List Driver</span></a>
